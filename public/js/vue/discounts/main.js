...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  getProducts: function getProducts(page) {
    return _api_client__WEBPACK_IMPORTED_MODULE_0__["default"].get("products-paginate?page=".concat(page));
  }
});
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.loading = true;
                _context.next = 5;
                return _services_product_service__WEBPACK_IMPORTED_MODULE_1__["default"].getProducts(page);
